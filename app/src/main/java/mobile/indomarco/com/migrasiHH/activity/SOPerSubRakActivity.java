...
public class SOPerSubRakActivity extends AppCompatActivity {
    ...
    private void getPLU() {
        ...
        JsonObjectRequest jobjReqPLU = new JsonObjectRequest(Request.Method.GET, URL, jobjParam, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                {
                    Toast.makeText(SOPerSubRakActivity.this, m1, Toast.LENGTH_SHORT).show();
                }
            }
        });

        Volley.newRequestQueue(SOPerSubRakActivity.this).add(jobjReqPLU);
    ...
    private void searchList() {
        ...
        Volley.newRequestQueue(SOPerSubRakActivity.this).add(jobjReqList);
    ...
    private void cekInitial() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status.equals("True")) {
                        ...
                        Intent home = new Intent(SOPerSubRakActivity.this, HomeActivity.class);
        ...
        Volley.newRequestQueue(SOPerSubRakActivity.this).add(jobjcekInit);
    ...
    private void submitProcess() {
        ...
        Volley.newRequestQueue(SOPerSubRakActivity.this).add(jobjSubmit);
    ...
    private void showErrorDialog(String messageError) {
        ...
        if (getBHS.equals("ENG")){
            if (messageError.equalsIgnoreCase("ERR1")){
                ...
                message = "Location don't storage!";
            ...
            if (messageError.equalsIgnoreCase("ERR1")){
                ...
                message = "Lokasi tidak boleh storage!";
            } else if (messageError.equalsIgnoreCase("ERR5")){
